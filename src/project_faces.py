...
file_name = '../data/test_pics/pitchers/0a0a6b54d6e52cab38c7bcb3105ac8131cad163b.jpg'
...
for i, face_rect in enumerate(detected_faces):
	...
	cv2.imwrite("../data/projected_faces/pitchers/{}".format(file_name[27:]), alignedFace)

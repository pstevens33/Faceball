...
model.fit(X_train, y_train_ohe, epochs=1000, batch_size=128, verbose=1) # cross val to estimate test error
...
model.save('../data/models/gpu_1000_players_sigmoid_binary.h5')
